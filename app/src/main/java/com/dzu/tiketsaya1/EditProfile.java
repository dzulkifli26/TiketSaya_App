...
public class EditProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                xemail_address.setText(dataSnapshot.child("email_addres").getValue().toString());
                Picasso.with(EditProfile.this).load(dataSnapshot.child("url_photo_profile").getValue().toString()).centerCrop().fit().into(photoeditprofile);
            }
            ...
            public void onClick(View v) {
                ...
                reference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        dataSnapshot.getRef().child("email_addres").setValue(xemail_address.getText().toString());
                    }
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            storageReference1.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    // berpindah activity
                                    Intent goprofile = new Intent(EditProfile.this, ProfileActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == photo_max && resultCode == RESULT_OK && data != null && data.getData() != null ){
            ...
            Picasso.with(this).load(photo_location).centerCrop().fit().into(photoeditprofile);
